...
class grupo extends AdminController
{
    ...
    public function index()
    {
        ...
        //Permissões
        $this->data['cadastragrupousuario'] = $this->viewGrupoAcaoModel->verificaPermissao('admin/grupo/criar');
        $this->data['editargrupousuario'] = $this->viewGrupoAcaoModel->verificaPermissao('admin/grupo/editar');
        $this->data['permissaogrupousuario'] = $this->viewGrupoAcaoModel->verificaPermissao('admin/grupo/permitir');
        $this->data['deletargrupousuario'] = $this->viewGrupoAcaoModel->verificaPermissao('admin/grupo/deletar');
    ...
    public function editar($id = NULL)
    {
        ...
        $this->data['grupo'] = $this->grupoModel->Recupera(Array('id' => $newid));
    ...
    public function permitir($id = NULL)
    {
        ...
        $this->data['controllers'] = $this->acaoModel->recuperaAcoesParaPermissao($newid);
    ...
    public function alterar()
    {
        ...
        if ($this->form_validation->run())
        {
            ...
            $result = $this->grupoModel->alterar($dados);
            if ($result)
            {
    ...
    {
        $dados = $this->_request;
        $result = $this->permissaoModel->atualizarPermissao($dados['idGrupo'], $dados['idAcao']);
        if ($result)
        {
    ...
    public function deletar()
    {
        ...
        if ($this->grupoModel->deletar($idGrupo))
        {
            $this->session->set_flashdata('sucesso', 'O Grupo de Usuário '
