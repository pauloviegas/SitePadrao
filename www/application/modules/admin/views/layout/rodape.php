...
<script src="<?= $url_base . 'assets/plugins/jquery-block-ui/jqueryblockui.js' ?>" type="text/javascript"></script> 
...
<!-- BEGIN PROJECT JS FRAMEWORKS -->
<script src="<?= $url_base . 'assets/js/tabs_accordian.js' ?>" type="text/javascript"></script>
<!-- END PROJECT JS FRAMEWORKS -->
